---
title: "Paso 4.- Análisis GSEA (31773)"
author: "Borja Gómez"
date: "20/11/2021"
output: 
  html_document:
...
```{r}
anmat <- toTable(hgu133plus2GO)
anmat_kegg <- toTable(hgu133plus2PATH)
```
...
Podemos visualizar la variable rindex en función del estadístico T y el pvalue, para poder observar cual es la proporcion de genes sobre e infra expresados así como el valor de los p-valores obtenidos
...
A continuación vamos a darle forma a la anotación, agrupando los distintos genes en clusters representados por términos GO usando la función annotMat2lis.
Además debemos comprobar que nuestros genes significativos y los genes que acabamos de agrupar en clusters conformando nuestro "universo" de genes coinciden. También vamos a aprovechar para filtrar dichos clusters de forma que solo trabajaremos con aquellos con un tamaño 10:500 genes.
...
Y una vez terminado podemos realizar el visionado de los resultados. Podemos emplear la función uvPat que va a clasificar los genes en significativos y upregulated, significativos y downregulated o no significativos. Además vamos a obtener el nombre de los terminos GO relacinoados con nuestros genes y finalmente nos quedaremos con aquellos cluster significativamente enriquecidos.<br>
...
save(resultado_asma, file ="data/diff_exprs_31773/asma_GO_31773.rda")
```
...
save(resultado_asma_kegg, file ="data/diff_exprs_31773/asma_KEGG_31773.rda")
```
...
save(resultado_severo, file ="data/diff_exprs_31773/severo_GO_31773.rda")
```
...
save(resultado_severo_kegg, file ="data/diff_exprs_31773/severo_KEGG_31773.rda")
```
...
save(resultado_enfermos, file ="data/diff_exprs_31773/enfermos_GO_31773.rda")
```
...
save(resultado_enfermos_kegg, file ="data/diff_exprs_31773/enfermos_KEGG_31773.rda")
```
