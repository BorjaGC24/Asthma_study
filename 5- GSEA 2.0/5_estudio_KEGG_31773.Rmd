---
title: "Paso 5.- Análisis GSEA 2.0 (31773)"
author: "Borja Gómez"
date: "20/11/2021"
output: 
  html_document:
...
save(rutas_asma, file = "data/31773_KEGG/rutas_asma.rda")
```
...
#term_gene_graph(rutas_asma, num_terms = 5, use_description = TRUE)
...
save(rutas_severo, file = "data/31773_KEGG/rutas_severo.rda")
```
...
term_gene_heatmap(rutas_severo, use_description = TRUE, num_terms = 11)

# No recomendado, la visualización no es muy bonita
term_gene_graph(rutas_severo, num_terms = 11, use_description = FALSE)

#Vamos a coger las 15 más relevantes
clustered_df = cluster_enriched_terms(rutas_severo[1:11,], plot_hmap = TRUE, plot_dend = TRUE, use_description = TRUE, method = "hierarchical")
```
...
# No recomendado, la visualización no es muy bonita
term_gene_graph(rutas_enfermo, num_terms = 8, use_description = TRUE)
